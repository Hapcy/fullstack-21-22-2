```git checkout tematika-kovetelmenyek```

# Tematika

Full-stack alkalmazás fejlesztése
- Két részt külön-külön már tanultátok
- A konkrét keretrendszerek fognak változni:
  - Szerver oldal: NestJs
  - Kliens oldal: Angular
- Kicsit tervezőibb szemlélettel megközelítve
  - Mit is kell tudnia az alkalmazásnak
  - Hogyan nézzen ki a felület
  - Hogyan modellezzük a domaint
  - Hogyan tervezzünk REST API-t
- Szerver oldal
  - IOC container
  - ORM
...
- Félév során nagy beadandó elkészítése
  ...
  - Mérföldkövek - az 1. és a 4. fontos
    ...
    - 12. hétig frontend elkészítése + dokumentáció (elég backend integráció nélkül)
  - Vizsgaidőszak ideje alatt az integrált alkalmazás bemutatása (valószínűleg január első, második hete)
